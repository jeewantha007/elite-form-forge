      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-3 mb-4">
            <img src={logo} alt="NSS Fitness Centre" className="h-16 w-auto" />
            <h3 className="text-2xl tracking-widest text-foreground">
        ...
        <div>
          <h4 className="text-sm tracking-widest mb-4 text-foreground">QUICK LINKS</h4>
        ...
        <div>
          <h4 className="text-sm tracking-widest mb-4 text-foreground">CONTACT</h4>
        ...
        <div>
          <h4 className="text-sm tracking-widest mb-4 text-foreground">FOLLOW US</h4>
