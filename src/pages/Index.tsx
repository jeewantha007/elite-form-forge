      ...
      <div className="container mx-auto px-4 relative z-10 pt-16">
        <motion.div initial="hidden" animate="visible" className="max-w-2xl">
          ...
          <motion.p variants={fadeUp} custom={3} className="text-lg text-white/60 mb-8 max-w-md font-light">
            Train with Sri Lanka's Elite Fitness Coach at NSS Fitness Centre.
          </motion.p>
    ...
    <section className="py-24 bg-muted">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl text-foreground mb-4">WHY <span className="text-primary">NSS FITNESS CENTRE</span></h2>
