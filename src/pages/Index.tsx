  ...
  <div className="bg-background min-h-screen">
    ...
    <section className="py-24 bg-muted">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl text-foreground mb-4">WHY <span className="text-primary">ELITEFIT</span></h2>
    ...
    <section className="py-24 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-white/70 mb-8 max-w-md mx-auto">Join EliteFit today and begin your transformation journey.</p>
