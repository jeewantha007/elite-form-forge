...
const MemberMembership = () => (
  <>
    ...
    <DashboardLayout links={memberLinks} title="Member Panel">
      <h1 className="text-3xl text-primary-foreground mb-8">MEMBERSHIP</h1>
      <div className="max-w-2xl">
        <div className="bg-gym-dark border border-primary-foreground/5 p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h2 className="text-2xl font-heading text-primary-foreground mb-1">PRO PLAN</h2>
              <p className="text-sm text-primary-foreground/50">LKR 8,500 / month</p>
            </div>
          ...
          <button className="mt-8 bg-primary text-primary-foreground px-6 py-3 font-heading text-sm tracking-wider hover:bg-primary/90 transition-colors">
            UPGRADE PLAN
          </button>
        </div>
      </div>
